...
RESULTS_PATH = 'results/pick/b/'
RESULTS_PATH = 'results/pick/r/'
RESULTS_PATH = 'results/pick/md/'
RESULTS_PATH = 'results/pick/w/'
RESULTS_PATH = 'results/pick/'
...
def main():
    ...
    for filename in sorted(os.listdir(RESULTS_PATH)):
        if filename.startswith('g-'):
            filename_pattern = re.compile(r"g-(.)d(\d+)-\d+")
